#if !defined(BEACH_INVOCATION_COMMAND_CALL_ARG)
#define      BEACH_INVOCATION_COMMAND_CALL_ARG
//----------------------------------------------------------
...
public:
    ...
    command_call_arg( const command_call_arg & );
    command_call_arg(
        T &                 in_object,
...
private:
    ...
    command_call_arg & operator=( const command_call_arg & ) { return *this; }

    T &                     _object;
    type_method_pointer     _method;
    A                       _arg;

}; // end of class template command_call_arg
...
//----------------------------------------------------------
#endif // BEACH_INVOCATION_COMMAND_CALL_ARG
