#if !defined(BEACH_COLLECTION_POINTER_MAP_BY_INTEGER)
#define      BEACH_COLLECTION_POINTER_MAP_BY_INTEGER
//----------------------------------------------------------
...
//----------------------------------------------------------
/**
 *  @file       pointer_map_by_integer.hpp
...
/// map of pointers, keyed by integer
/**
 *  This is intended as the superclass for the
 *  ref_map_by_integer<T> template. This provides substitutability
 ...
 *              - Iterator [GoF]
 */
class pointer_map_by_integer
    : public std::map<atoms::integer,atoms::pointer_to_const>
{
public:

    typedef std::map<atoms::integer,atoms::pointer_to_const> superclass;

    BEACH_ALLOCATION_OPERATORS

    /// construction of non-owning collection
    pointer_map_by_integer()
      : superclass(), _destroyer( 0 )
    {}
    /// construction of owning collection
    /** client must provide destroyer object for the element type */
    pointer_map_by_integer( const atoms::destroyer_interface & d )
...
}; // end of template class pointer_map_by_integer<T>
...
//----------------------------------------------------------
#endif // BEACH_COLLECTION_POINTER_MAP_BY_INTEGER
