#if !defined(BEACH_COLLECTION_REF_MAP_STRINGEX)
#define      BEACH_COLLECTION_REF_MAP_STRINGEX
//----------------------------------------------------------
...
#include <collection/pointer_map_by_string.hpp>
...
/// map of references to a single type, keyed by string
/**
 ...
 */
template <typename T>
class ref_map_by_string
    : public pointer_map_by_string
{
public:
    ...
    typedef T *                     ptr_type;
    typedef T &                     ref_type;
    typedef pointer_map_by_string   superclass;
    ...
    ref_map_by_string( const atoms::destroyer_typed<T> & d )
      : superclass( d )
    {}
...
}; // end of template class ref_map_by_string<>
...
//----------------------------------------------------------
#endif // BEACH_COLLECTION_REF_MAP_STRINGEX
