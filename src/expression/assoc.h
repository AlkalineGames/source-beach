...
#ifdef __GNUC__
// Use this once in an implementation file
#define DECLARE_ASSOC(classtype) template class SubList<Binar<classtype> >;\
template class Binar<classtype>;\
template class SPList<Binar<classtype> >;\
template class SPListBase<Binar<classtype> >;\
template class Assoc<classtype>;\
template ostream& operator<<(ostream &, Assoc<classtype> const &);\
template ostream& operator<<(ostream &, Binar<classtype> const &);
#endif
