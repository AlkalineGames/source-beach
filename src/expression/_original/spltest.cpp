...
#ifndef _MSC_VER
// For some reason MSVC doesn't like these
// But they are needed for Watcom and GCC
ostream& operator<<(ostream &, const SPList<int>  &);
ostream& operator<<(ostream &, const SPList<char *> &);
#else
#include <crtdbg.h>
#endif
...
// test Regexp stuff
    cout << endl;
    cout << "testing regexp stuff:" << endl;
    x.reset();
